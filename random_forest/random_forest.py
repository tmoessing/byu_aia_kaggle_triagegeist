...
plt.close()
print(f"Saved: random_forest/feature_importance.png")
...
submission.to_csv("random_forest/submission.csv", index=False)
print(f"Saved: random_forest/submission.csv")
print(f"Submission shape: {submission.shape}")
print(f"Prediction distribution:\n{pd.Series(test_preds).value_counts().sort_index()}")

print("\n✅ Done! Upload random_forest/submission.csv to Kaggle.")
