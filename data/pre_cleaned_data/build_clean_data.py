...
train = pd.read_csv("data/pre_cleaned_data/train.csv")
test = pd.read_csv("data/pre_cleaned_data/test.csv")
patient_history = pd.read_csv("data/pre_cleaned_data/patient_history.csv")
chief_complaints = pd.read_csv("data/pre_cleaned_data/chief_complaints.csv")
